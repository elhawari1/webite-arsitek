                ...
                <table id="example1" class="table table-bordered table-striped" style="text-align: center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $data->title }}</td>
                            <td>
                                <a href="{{ asset('storage/image_admin/banner/'.$data->image) }}" data-lightbox="models"
                                    data-title="{{ $data->title }}">
                                    <img src="{{ asset('storage/image_admin/banner/'.$data->image) }}" width="20%;"
                                        height="10%"></td>
                            </a>
                            <td>
                                <button type="button" class="btn btn-outline-warning" data-bs-toggle="modal"
                                    data-bs-target="#update{{ $data->id_banner }}"><i class="icon fa fa-edit"
                                        title="Edit"></i></button>
                                <a href="#" class="btn btn-outline-danger delete" data-id={{ $data->id_banner }}
                                    data-title={{ $data->title }}>
